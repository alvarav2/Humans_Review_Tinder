...
training_set = csr_matrix((t_data, (t_row, t_col) ), shape=(len(train_targ),75000)).toarray()

development_set = csr_matrix((d_data, (d_row, d_col) ), shape=(len(dev_targ),75000)).toarray()

r = linear_model.LinearRegression()

r.fit(training_set, train_targ)

my_pred = r.predict(development_set)
